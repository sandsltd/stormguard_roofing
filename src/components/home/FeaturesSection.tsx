  ...
  return (
    <section className="py-24 relative bg-gradient-to-b from-white to-gray-50">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-blue-50 rounded-full opacity-30"></div>
        <div className="absolute top-24 -left-12 w-64 h-64 bg-blue-50 rounded-full opacity-30"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          {content.homepage.features.map((feature, index) => (
            <div 
              key={index} 
              className="bg-white rounded-xl shadow-lg p-8 transform transition-all duration-300 hover:scale-105 hover:shadow-xl border-t-4 border-blue-500"
            >
              ...
              <div className="mt-6 pt-6 border-t border-gray-100">
                <a href={feature.learnMoreLink || '#'} className="inline-flex items-center text-blue-600 hover:text-blue-700 font-medium">
